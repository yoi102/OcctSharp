...
- The current line began at `8.0.1-preview.1`; the current package is
  `8.0.1-preview.16` (locally validated Batch Q). Increment the preview counter for an
...
- Keep package, managed assembly, generator, native ABI, bridge, binding-model schema,
  ...
  Preview.16 managed assembly identities remain `0.1.0.0`; native ABI is 1.60 and bridge
  implementation is 0.68.0. Batch Q keeps schema 1.13. Each batch is locally packaged
