# Historical status snapshots through Preview.22

Archived on 2026-09-06 under ADR-0091. The original status body below is preserved,
including stale active-loop text from earlier checkpoints. It is historical evidence,
not current instructions. Use [STATUS](STATUS.md) for current progress and
[WORKFLOW](WORKFLOW.md) for current execution policy.

# Current Status

- Last updated: 2026-09-06
- Resume: Q-W implementation and full local validation are complete, 280/280. This checkpoint closes W as one whole batch; no queued implementation remains. Final documentation-package evidence is recorded below. No NuGet publication or GitHub push.
- W outcome: all original forty rows close viewer-owned profiles/lights/appearance/textures/environments/layers, copied color/depth frames, complete cameras, explicit-key recipe replay and WPF snapshots. Real PBR/MSAA/OIT/path-tracing/IBL, missing-UV and XDE reset/isolation tests pass. Explicit FBO ownership restores capture state without screen fallback. Preview.22 / ABI 1.66 / bridge 0.74.0 and the bundled DLL are synchronized.
...
- Execution: continuous Q-W is COMPLETE, 280/280 (100%) in the finite prepared scope. Q `1a3662a`, R `86e069c`, S `580bb22`, T `bfb8811`, U `2c48460`, V `2c76e10`; W is this whole-batch completion checkpoint. No NuGet publication or GitHub push.
- Preparation workstream: ADR-0083's seven whole 40-capability batches (280 rows) are implemented and locally validated. Original preparation inputs remain frozen. Preparation-era zero implementation/no-code-change statements below are historical, not current product state.
...
- Current phase: B-W are locally complete for their accepted finite scopes. The authorized Q-W queue has no remaining batch. This is not a claim that every OCCT declaration has been migrated or that public-release gates are complete.
...
- Batch U: 40/40 original capabilities implemented and locally validated under ADR-0088, with KI-034's explicit shell-limit eligibility. Focused 96/96 and ten repeats; Release/Debug and actual Debug-native 409/409; full release-check, exact 108-ID accounting and final documentation-package verification pass.
- Batch V: 40/40 original capabilities locally validated. Focused 37/37 and ten repeats, Release/Debug Generator 91/91 and Runtime 446/446, actual Debug-native 446/446, both consumers, 94-file clean regeneration, exact 27-ID accounting and complete release-check pass.
- Batch W: 40/40 locally complete. Focused 23/23 and ten repeats; Release/Debug Generator 91/91 and Runtime 469/469; actual Debug-native 469/469; exact86 accounting, both consumers, 94-file cold regeneration and complete local release-check pass.
- Complete-migration batch progress: B through W are complete locally; retired B00-B20 and forbidden numbered/dotted labels are not counted as batches.
- Accepted surface: 16,353 generated manifest IDs plus 1,217 accepted manual stable IDs; Release/Debug native/managed builds, Generator 91/91, Runtime 469/469, discovery/report determinism, generated dependency closure and dependency profiles 6/6 pass.
- Last complete full inventory: 116,272 declarations and 7,090 headers have final dispositions; Emitted 16,353, Manual 1,217, SupportedUnselected 0, Skipped 49,344, Blocked 49,358, pending 0, HD099 0. SHA256 `260AE9A603E7B68F717C38C3FAF9C68A83F866D0154E84E1CD7FD811DB0C6A2C`. 7,058 headers were semantically parsed; 32 retain their previous explicit exclusions. W accounting passes for exactly 86 SC-060 transitions and zero other changes; classification is not a claim of complete OCCT API migration.
- Overall state: Preview.22 validates Batch W with twelve module assemblies plus the compatibility/facade assembly, one Native DLL and one shared native runtime package. Identities: package 8.0.1-preview.22, assembly/file 0.1.0.0, ABI 1.66, bridge 0.74.0, schema 1.13. Physical Native DLL splitting, hosted CI, signing, NuGet publication and GitHub push are not included.
...
### Preview.21 Batch V local validation

- All original forty matrix rows have named numerical/topological/lifetime assertions.
  Focused 37/37 and ten final repeated runs pass. Release/Debug and cold-source builds
  pass Generator 91/91 and Runtime 446/446; isolated actual Debug-native passes 446/446.
  Evidence: `artifacts/batch-v-release-check-final.log`, `batch-v-actual-debug.log`,
  `batch-v-dimension-final.log`, and `batch-v-repeat-1.log` through `-10.log`.
- Entry is committed U `2c48460`. The fresh entry inventory repeats U exit
  `77900ED8`; frozen-to-entry comparison finds 395 classification changes, 28 in V
  roots, with zero added/removed/identity-changed declarations. Two 43-root /
  2,075-candidate audits match SHA256
  `1625F288E0AD7D0779B35A6D28BC13ABA1925AAB17C206DCC3C1EB2A7601B27E`.
  Original Preview.15 preparation remains unchanged.
- ADR-0089 implements Modeling regions and three cohesive native units, reusing
  FeatureResult/Shape owners. Source checks pass: 79 independent units, 601 manual C
  exports, 23 shared storage definitions, 43/43 strict private headers and six layout
  negatives. Release/Debug export parity is 29,475; exactly five C calls are added,
  none removed. Managed compatibility against U adds 561 signatures, removes zero;
  3,458 facade forwarders were regenerated. Evidence: `batch-v-headers.log`,
  `batch-v-layout-negative.log`, `batch-v-export-parity-final.log` and
  `batch-v-validation/api-diff.json`.
- Bundled Release bridge is 15,912,448 bytes, SHA256
  `59CEB483A3AAE4EDD4098BB9862194A428F5E030707A5428796AF575193C2425`.
  Actual Debug bridge SHA256 is
  `B3177507C66A29FE562BAE6C6693C4FBFBFD0265E0D6092A661ECB0A0E3EE339`;
  all 62 Debug DLL hashes are checked in
  `artifacts/batch-v-validation/actual-debug/result.json`.
- Final full release-check passes: fresh console smoke, both clean package consumers,
  fourteen packages, generated dependency closure/profiles and a clean-source build
  reproducing all 94 generated files byte-for-byte. Final inventory matches the V
  exit hash above exactly. The 27 SC-059 transitions and all three accounting negatives
  pass; no declaration identity changes or new header exclusions occur. Evidence:
  `artifacts/generator-reports/batch-v-manual-accounting.json`,
  `artifacts/batch-v-validation/accounting-final/` and the complete checker log.
  Exit API/native/inventory copies are in
  `artifacts/preparation-baselines/preview21-batch-v/`.
- Both real-HWND captures (`artifacts/batch-v-viewer/interfaces.png` and `void.png`)
  were visually inspected. STEP preserves explicit body names and styles; this IGES
  path preserves geometry/colors/root name, not nested names. Region metadata is
  verified after BinXCAF reopen. Q repair composition is input-owner provenance,
  not invented complete subshape history.
- Frozen Q-W preparation passes: 280 rows, 223 SDK headers, 7,668 candidates, fourteen
  negative checks and sixteen representative symbols. The auditor counts only frozen
  capability rows, not later assertion maps. Markdown fences and all 381 local links
  pass; whitespace checks pass. Final documentation repack and both consumers pass in
  `artifacts/batch-v-document-package-final.log`; package-content validation verifies
  178 stable documents, 73 runtime/license files and five checksums/provenance.
  Final facade package SHA256:
  `D9A3208CC22F6D53EF6E71D7CD30A7A33B3B5500D75C6656F5100D539746A988`.
  Whole-batch local commit is `2c76e10`; W entry has advanced automatically.
  Public-release readiness remains false: hosted CI, signing, publication and push
  are NOT RUN and outside this local implementation run.

### Preview.20 Batch U local validation

- Fresh 128-header inventory repeats the T exit hash `1A4B9369EA89E89F9A71BC12E190196FD010B716681939E935BEAC840A69FDBA`.
  Exact comparison against the frozen Preview.15 inventory finds 287 classification
  changes (16 affecting U roots), zero added/removed declarations and zero identity changes.
- Both exact 44-root / 2,045-candidate reports match SHA256
  `43FF988F7A234BE1CFC15C654951BA01853F81F9DD35581E2B2984960DD65BB3`:
  927 Blocked, 431 Emitted, 129 Manual and 558 Skipped. Frozen configuration is preserved;
  post-T configuration is `config/batches/batch-u-entry.json`.
- Entry artifacts: `artifacts/generator-reports/batch-u-entry-inventory-128.json`,
  `batch-u-entry-delta.json`, `batch-u-entry-roots-1.json` and `batch-u-entry-roots-2.json`.
  U implementation now passes 96/96 focused cases in `artifacts/batch-u-current-runtime.log`,
  including ten final-source consecutive repeats in `batch-u-repeat-1.log` through `-10.log`.
  This includes a real HasResult/BadShape corner-plate failure, all eight semi-infinite
  prism modes, closed-law seams and compatible/conflicting vertex anchors, tangent draft
  propagation/problem faces, sliding membership, final-group correspondence, raw capacity
  sentinels, stale/ambiguous XDE publication, and four-format limited/fillet recipe reexecution.
  The original forty-row assertion map is retained in the U matrix. No exploratory test
  substitutes for partial-result acceptance. Current target is Preview.20 / ABI 1.64 /
  bridge 0.72.0; schema and assembly versions stay unchanged. SC-058 records 108 exact
  direct/virtual-dispatch blocked IDs. The first Release build stopped at stale facade
  forwarders; the supported forwarder generator regenerated 3,418 entries, and the fresh
  final whole Release build passes Generator 91/91 and Runtime 409/409 with zero warnings/errors.
  Regeneration is deterministic at 94 files; source layout passes 76 units / 596 manual
  exports / 23 storage definitions and all six negative cases. The rebuilt Release
  runtime matches all 62 bundled DLLs and eleven unchanged notice/license files.
  Full Debug managed also passes Generator 91/91 and Runtime 409/409. Actual Debug-native
  exposed KI-034's shell-draft SDK assertion and unsafe non-edge Generated query.
  Edge-only history and explicit single analytic-edge limit preconditions are now
  implemented with expanded success/rejection tests. Actual Debug-native passes 409/409
  with all 62 DLL hashes checked (`artifacts/batch-u-actual-debug-accepted.log` and
  `batch-u-validation/actual-debug/result.json`). Final laterals are exact native-generated
  final faces, distinct from PreLimitShape. The new Release bridge is 15,867,904 bytes,
  SHA256 `7B88C356749F6502DDFF47657695C562BBC0E20A65912F3D9821CD2BCB5CBA50`;
  it matches the bundled runtime. All 42 strict headers pass; current Release/Debug
  exports match at 29,470 (11 additions, zero removals); managed API adds 592/no removals.
  Final full release-check passes in `artifacts/batch-u-release-check-final2.log`, including
  both clean consumers, all 14 packages and 94 byte-identical cold-regenerated files.
  Cold-source Generator 91/91 and Runtime 409/409 pass. SC-058 accounting passes exactly
  108 transitions/no other changes, plus all accounting negatives. Header verification
  restores the complete process environment on success and failure, tested in
  `artifacts/batch-u-validation/header-environment/result.json`; this prevents vcvars
  Platform=x64 from contaminating subsequent .NET solution restores. Final viewer
  sections/limit/fault screenshots have been inspected with their base-shape context.
  Final documents were repacked and both consumers passed again; package-content
  verification passes for 176 stable documents, 73 runtime/license files, five checksums
  and final provenance. Evidence: `artifacts/batch-u-final-doc-package.log`,
  `batch-u-final-doc-content.log` and `artifacts/release/package-content.json`.
  Exit baselines are retained under `artifacts/preparation-baselines/preview20-batch-u/`:
  `api.json` (42,387 signatures), the verified Native DLL and `full-inventory-128.json`.
  Committed as `2c48460`; V entry reconciliation follows without another confirmation.
...
- The first combined checker invocation stopped before restore because the standalone
  ...
  Whole T local completion commit: `bfb8811`. U entry follows; Q-W CONTINUE at 160/280.

### Preview.18 Batch S local validation

- All 40 original capabilities remain in scope. New Geometry laws, Modeling plans
  and owning results, facade conversion/delivery/review and eight cohesive Native
  units are implemented; no new project, native DLL or owner registry is introduced.
- `artifacts/batch-s-residual-safety-build.log` passes Release native/managed compile
  and deterministic generation. Twelve consecutive full 40-case focused runs pass
  (`batch-s-safe-1.log` through `batch-s-safe-12.log`). This follows, and does not
  erase, the earlier intermittent heap failures in `batch-s-repeat-8.log` and the
  pre-fix isolation run. Unsafe OCCT per-index filling error getters were removed;
  final-surface residuals are independently measured with explicit sampling limits.
- Expanded focused regression now passes 44/44 and ten consecutive repeats
  (`batch-s-stress-1.log` through `batch-s-stress-10.log`), including 48 low-sampling/
  high-iteration G2 solves per run, punctual-loft endpoint provenance and foreign-review
  atomicity. All 39 private headers pass standalone `/Zs /W4 /WX`; six layout negative
  checks pass. Managed comparison against R adds 500 signatures and removes none.
  Preview.18 / ABI 1.62 / bridge 0.70.0 are synchronized; bundled Release bridge
  SHA256 is `B0B8BB697CF865C8D2F9E8A04269C02329D6916CD73EE31DF70CBDEAA5EBCB8E`.
  All 62 DLLs and 11 notices/license files match the manifest. Release Generator
  91/91 and Runtime 273/273 pass; isolated actual Debug-native also passes 273/273.
  Debug bridge SHA256: `5417E7F90A3867CDA10481886BB2B6537B72DF6165041F662FC5548D2E6645DA`.
- Native compatibility passes with 29,443 identical Release/Debug export names:
  all 29,432 R names plus nine C functions and two MSVC/OCCT default-construction
  helper symbols (`??_FBRepOffsetAPI_MakeFilling@@QEAAXXZ` and
  `??_FGeomConvert_CompCurveToBSplineCurve@@QEAAXXZ`). Helpers are not managed APIs.
  Exact-ID verifier negatives pass 3/3 with all inputs unchanged.
- The first release-check failed at a flaky existing R wrong-thread fixture:
  Task.Run plus synchronous waiting could inline on the creating thread. It now
  uses an explicit distinct Thread; targeted Debug 7/7 passes. Final full gate
  rerun is `artifacts/batch-s-release-check-final.log`. Final actual Debug-native
  passes 273/273 again in `artifacts/batch-s-validation/actual-debug-final/result.json`.
  Release/Debug Generator 91/91 and Runtime 273/273, 14 package asset audits, both
  clean consumers, and cold-source Generator 91/91 plus Runtime 273/273 pass. All
  94 generated files are byte-identical; only the known temporary-directory MSB8029
  advisory is emitted by the fresh build. Console smoke and three inspected real-HWND
  captures pass. Final full inventory and exact 68-ID accounting pass with no other
  changes; three negative cases pass with original inputs unchanged.
- Final documentation repack and both consumers pass in `artifacts/batch-s-package-final.log`.
  Package-content verification confirms all 172 stable documents, 73 runtime/license
...
- The original 40-row acceptance matrix maps exactly once to 25 focused tests across
  three files. Fixtures cover real broken wires/shells, small features/holes, division,
  sewing/unification, protected corners, explicit edits, atomic failure and ownership.
  Adjacent vertex merges have explicit many-to-one history. Actual 2D/3D gap residuals
  are measured; missing pcurves are Unavailable. Placement baking removes serialized
  locations while preserving world geometry. No capability was dropped or renumbered.
- Final `artifacts/batch-q-release-check.log` passes Release/Debug Generator 91/91 and
  Runtime 205/205, six dependency profiles, 94 current generated files, 27 acyclic
  cross-shard edges, 3,282 forwarders, fresh-source build and byte-identical generation,
  14 package asset audits, both clean consumers, full inventory and local release gates.
  Clean compilation emits only the known MSB8029 temporary-directory advisory.
- The isolated final Debug-native sweep also passes 205/205; evidence is
  `artifacts/batch-q-validation/actual-debug-runtime-final.log` and its TRX. Actual
  Debug bridge SHA256: `0BC46EC8698FB52CB06E83D84680CA893F650CC68151A08A4CC31414E2032FC7`.
  All 62 isolated Debug DLLs were compared with the rebuilt Debug closure.
- All 35 private headers pass standalone MSVC `/Zs /W4 /WX`. Source layout passes
  with 51 independent units, 544 manual exports and 23 unique storage definitions;
  six negative layout fixtures pass. Release/Debug expose the same 29,416 names,
  retaining all 29,402 prior exports plus the fourteen Q entries. Managed comparison
  adds 540 signatures against Preview.15 (39,821 against alpha.38), with zero removals.
- SC-054 reconciles exactly 106 Blocked-to-Manual stable IDs, with zero other
  declaration/identity/classification changes. The reusable accounting verifier's
  three negative cases pass: wrong baseline hash, input overwrite and unimplemented
  transitions. Reports are `batch-q-manual-accounting.json` and the validation logs.
- Real repaired shared definitions retain two placements, names/colors, protected
  metadata and undo/redo. STEP/IGES reimport preserves validity, scale and area 200;
  native HWND selection/screenshots and stale-ID rejection pass. The shared public-only
  workflow also passes in the clean facade consumer; direct Modeling stays facade-free.
- The 15,549,440-byte bundled Release bridge matches the rebuild at SHA256
  `29705D13CB1D6C25A81346B504E97DE963758A73B87F07D1164D697C1878D2D3`.
  All 62 DLLs and 11 notices/licenses match the runtime manifest. Console smoke passes.
  Final documentation was repacked; both consumers passed again. All 17 final changed
  package documents, 62 DLLs, 11 notices/licenses and five release checksums match.
  Final facade package SHA256:
...
- The complete 13,510-line legacy implementation is replaced by 39 domain-owned source
  files and 33 private headers. Including existing Surfaces files, the manual bridge
  has 42 independent translation units and 34 private headers in ten folders. The
  largest implementation is 855 lines; the largest private header is 132 lines.
- All 693 original function bodies and 511 complete historical C ABI definitions are
  preserved. The 530 total manual C definitions are unique. The registry mutex and
  20 live sets have one owner; the TLS diagnostic buffer also has one owner. No API,
  algorithm, ownership category, stable-ID classification, package or ABI version changes.
- All manual sources compile without PCH/unity in Release and Debug; all 34 private
  headers pass standalone MSVC syntax checks with zero warnings in the final probe.
  Six negative layout fixtures are rejected. Three new tests cover cross-unit shape
  registration/release, shared domain diagnostics and thread-local error isolation.
- Release/Debug Generator 91/91 and Runtime 180/180 pass. Final Release-native and
  isolated actual Debug-native runtime sweeps both pass 180/180. Console smoke,
  existing STEP/IGES/XDE/lifetime/real-HWND workflows and both package consumers pass.
- Release and Debug retain all 29,402 native export names. Against the 39,887-signature
  managed snapshot at `5620ae5`, API additions/removals are both zero. The public C
  headers, generated sources, 27-edge dependency graph and 3,233 forwarders are unchanged.
- Fresh-source compilation and a final header-only rebuild pass; all 94 generated
  files are byte-identical. Only the known clean-temp MSB8029 advisory is emitted.
  The complete local release check passes, and the full-inventory hash remains
  `CCB81F47CE09A7712D346C16EE45A9AF783D000DCFC64DF4B69FA3C1DE96DF48`.
- The committed 15,444,480-byte Release bridge has SHA256
  `7505EC19831B809DB419EAA1C86FC1BDF2AFFC242E59D4CC7B2D4B8B14F8A8FB`.
  The actual Debug bridge used by the final isolated test has SHA256
...
- Final documentation was repacked and both clean consumers passed again. The final
  ...
  `30ACAFB0BEE6081A703EDBE2EFC4CE8651C1F3A506DE8F2C25DEFC59BAA73C46`.
  All 62 packaged DLLs and 11 notices match the committed runtime bytes; all nine
  changed package documentation files and five release checksum entries match.
...
- The complete 24-capability implementation is validated. Release/Debug pass
  Generator 91/91, Runtime 164/164, and both clean facade/direct Modeling consumers with
  one 62-DLL runtime, ABI 1.58, bridge 0.66.0, and package 8.0.1-preview.14.
- Final review fixed reversed trim, similarity transforms, negative conic solution
  parameters, shuffled open chains, single-curve self intersection, overlap endpoints,
  exact hole containment, adaptive area integration, and native gap-tolerance propagation
  on copied topology. Focused regression now passes 7/7 including real selection and
  STEP/IGES color/layer assertions. SC-052 records 52 exact blocked stable IDs.
- The native-Debug extension reproduced an inherited BRepTools_History assertion when
  container types were queried. The shared feature/freeform/basic-history guard now
  limits native queries to supported vertex/edge/face/solid shapes. A container regression
  was added; the final Release-native and Debug-native Runtime suites both pass 164/164.
- The complete local release check and final-code clean-source rebuild pass. All 94
  generated files are byte-identical; API comparison reports 39,046 additions and zero
  removals. Full inventory closes 116,272 declarations and 7,090 headers. The bridge
  is 15,395,840 bytes with SHA256
  `0E4CA204356B83C158A40B74D99CA6047D59D9FB975A62C1168FF2A650979D90`.
  Final packaging includes the corrected bridge and synchronized documentation. Clean
  source MSVC builds emit only the expected temporary-directory advisory MSB8029;
  repository Release/Debug solution builds have zero warnings/errors.
  No NuGet publication, signing, hosted full release, or GitHub push is performed.
- The final facade nupkg SHA256 is
  `0FAF39652983F310F62B99CE947C074238E8077A8B5D5B1ED78E45EA950B5D6E`.
  All 62 packaged native DLLs match the committed runtime byte-for-byte; the five
  release checksum entries agree with package/provenance/SBOM/API/gate files.
...
- The Preview.12 baseline audit covers exactly 24 roots and 1,593 candidates:
  ...
  bulk-promoted.
- Preview.13 uses native ABI 1.57, bridge 0.65.0, and schema 1.13. SC-051 reconciles
  exactly 15 directly used blocked declarations. Release and Debug build all 19 projects
  with zero warnings/errors; Generator 91/91, Runtime 156/156, focused Batch N 4/4, and
  dependency profiles 6/6 pass.
- Repository runtime and the clean facade consumer execute metadata-aware IGES read/
  import/write, independent name/color/layer options, copied diagnostics and units,
  Unicode input/output staging with failure cleanup, mixed STEP/IGES composition,
  round-trip, source/session disposal, and real-HWND XDE-label display. The direct
  Modeling consumer remains facade-free.
- All 94 generated files are fresh and byte-identical after clean regeneration. API
  comparison against alpha.38 is additive at 38,838 additions and zero removals. The
  complete inventory closes 116,272 declarations and 7,090 headers. The committed
  15,356,928-byte bridge is byte-identical to the Release rebuild with SHA256
  `7DD8EB7A3CF5EA975F45D2F84812FBB2521B0E35F87C500DF5A42E9FC64C9EAD`.
- Fourteen Preview.13 packages pass isolation, README/icon, facade/direct-module consumer,
  SBOM, provenance, and checksum gates. The facade nupkg SHA256 is
  `7F256466AD9D2ADB6946F228BC909F0558C422ABC5F305CF13B81A77DFFECA65`.
...
- STEP loading uses XDE/STEPCAF and displays whole free roots through native XCAF style
  collection. Inherited occurrence, part, face, edge, material-base, alpha, and visibility
  overrides are projected; only unstyled topology keeps the neutral fallback. Preview.12
  also recovers styled representation targets omitted by ordinary product transfer.
  Preview.13 routes IGES through IGESCAF/XDE and the same XDE-label display path, so
  supported IGES names, colors, layers, and visibility replace the former neutral-only path.
- Release and Debug sample builds pass with zero warnings/errors. A real Release process
  created the WPF window and OCCT OpenGL child viewport. Preview.12 real-file inspection
  shows `ArduinoUnoRev3PCB.step` at 241 roots/244 effective styles/17 distinct colors and
  `fullArduinoUnoRev3PCB.step` at 247 roots/763 effective styles/19 distinct colors; the
  first file was visually verified with board, chip, connector, pin, and component colors
  instead of uniform RGB `(216, 224, 236)`. D3DImage interop is `NOT IMPLEMENTED`
...
### Preview.12 STEP/XCAF presentation-style recovery

- ADR-0076 and SC-050 keep STEP model/transfer/style objects native-local while exposing
  copied, location-aware `XdePresentationStyle` values with independently owned topology.
- `OcctViewer.Display(XdeLabel)` applies inherited XCAF occurrence, part, subshape,
  material, alpha, and visibility styles to a single viewer-parent-bound presentation;
  the WPF sample now uses this path for each free XDE root.
- STEPCAF import pre-transfers styled AP242 targets, recovers representation transforms,
  installs decoded styles in XDE, and retains disconnected visible presentation geometry
  instead of silently dropping it.
- Package identity is `8.0.1-preview.12`, native ABI 1.56, bridge 0.64.0, and schema
  1.13. All 14 packages share the practical repository/package README and the 256-pixel
  transparent OcctSharp icon. Release and Debug build with zero warnings/errors;
  Generator 91/91, Runtime 152/152, dependency profiles 6/6, all 94 generated files,
  clean-source regeneration, the 14-package isolation audit, facade/direct-module
  consumers, API/inventory/SBOM/provenance/checksums, and Git whitespace gates pass.
- The committed 15,348,736-byte bridge is byte-identical to the Release rebuild with
...
Product batches B through P are complete for their finite accepted local denominators.
...
- Generator input: the schema 1.13 selected Windows-core closure in
...
- Batch O is complete at 24/24. Copied 2D definitions, inspection/edit, mixed loops and
  holes, planar topology/features, XDE/STEP/IGES, real HWND, lifetime, and clean package
  pass together. SC-052 reconciles 52 exact blocked declarations; Preview.14 local gates pass.
- Batch P is complete at 32/32. Surface/UV definitions, projection, copied curves,
  repair/trim/split, XDE/STEP/IGES and real-HWND package workflows pass together.
  SC-053 reconciles 100 exact blocked declarations; Preview.15 local gates pass.
- Custom rendering pipelines, arbitrary callbacks, optional integrations, low-frequency
  ...
  scope for D.
- Hosted full release execution, signing, Preview.15 NuGet publication/indexing, and the
  public-source consumer remain separate release-readiness work and are `NOT RUN`.
...
2. Continue the active BATCH_CONTINUOUS_EXECUTION run: Q/R/S are locally validated;
   after S's completion commit enter T -> U -> V -> W. Revalidate each entry baseline, finish
...
## Last validated product baseline: Preview.15 before ADR-0081

The following historical evidence belongs to completed Batch P at `5620ae5`.
The completed native source extraction has its own repeated validation below.

| Check | Result | Baseline evidence |
|---|---|---|
| Release/Debug solution | PASS | Zero warnings/errors; Generator 91/91 and Runtime 177/177 |
| Actual Debug native runtime | PASS | Isolated 177/177; focused Batch P 13/13 |
| Real exchange/viewer and consumers | PASS | STEP/IGES metadata/lifetime/HWND; facade and direct Modeling consumers |
| Generation and dependency closure | PASS | 94 byte-identical generated files; 27 acyclic cross-shard edges; 3,233 forwarders |
| Full inventory classification | PASS | 116,272 declarations; 16,353 Emitted, 709 Manual, 49,866 Blocked, 49,344 Skipped; no pending/HD099 |
| Full header semantics | PARTIAL | 7,058/7,090 parsed; 32 named dependency/artifact exclusions are explicitly classified |
| API compatibility | PASS | 39,281 additions and zero removals against alpha.38 |
| Local packages/release metadata | PASS | 14 packages, 62 DLLs, both consumers, SBOM/provenance/checksums |
| Hosted full release, signing/publication | NOT RUN | Outside local batch delivery |

The exact baseline hashes are recorded in the Preview.15 completion section above.

## Current native extraction validation

| Check | State | Evidence |
|---|---|---|
| Complete declaration move | PASS | 511 historical C ABI definitions and 693 function bodies retained |
| Source registration and state ownership | PASS | 42 explicit translation units, 530 total manual C exports, 22 unique manual shared storage definitions |
| Native Release/Debug and no-PCH compilation | PASS | Both independent native builds and managed solution builds pass with zero warnings/errors |
| Native symbols and managed API versus 5620ae5 | PASS | All 29,402 native names identical; managed API zero added/removed versus the 39,887-signature snapshot |
| Release regression and source-layout negative fixtures | PASS | Generator 91/91; Runtime 180/180 including three new cross-unit tests; six negative source fixtures rejected |
| Actual Debug-native runtime | PASS | Isolated 62-DLL Debug closure; Runtime 180/180; final bridge hash recorded above |
| Standalone private headers | PASS | 34/34 MSVC syntax checks; final probe has zero warnings |
| Packages and clean regeneration | PASS | 14 local packages, both consumers; fresh-source build plus final header rebuild, 94 identical generated files |
| Committed Release runtime | PASS | 62 DLLs and 11 notices match; 15,444,480-byte bridge; final SHA256 recorded above |
| Complete local release check | PASS | Fresh full inventory unchanged; SBOM, provenance and checksums generated; publication remains NOT RUN |

## Migration loop state

```text
LOOP_STATE: ACTIVE_CONTINUOUS_RUN
CURRENT_WORKSTREAM: ADR-0083 CONTINUOUS Q-W IMPLEMENTATION
CURRENT_PRODUCT_BASELINE: B THROUGH S LOCALLY VALIDATED; Q COMMITTED 1a3662a; R COMMITTED 86e069c; S READY TO COMMIT
ARCHITECTURE_PROGRESS: COMPLETE; INDEPENDENT COMPILE, ABI, RUNTIME, PACKAGE AND CLEAN-SOURCE GATES PASS
PREPARATION_PROGRESS: Q/R/S/T/U/V/W 7/7; 40 CAPABILITIES EACH; LOCALLY VALIDATED 120/280
CONTINUOUS_RUN: CONTINUE; Q -> R -> S -> T -> U -> V -> W
NEXT_ACTION: LOCAL S COMPLETION COMMIT; THEN T ENTRY DELTA AND WHOLE-BATCH IMPLEMENTATION WITHOUT ROUTINE CONFIRMATION
NEXT_PRODUCT_BATCH: T; ALL FOLLOWING SCOPES REQUIRE EXPLICIT BASELINE DELTAS AFTER PRECEDING COMMITS
BINDING_COVERAGE: 16353 GENERATED PLUS 931 ACCEPTED MANUAL STABLE IDS
FULL_PROFILE_ACCOUNTING: 116272 CLASSIFIED; 49644 BLOCKED; 49344 SKIPPED; ZERO PENDING/HD099
LAST_COMPLETED_PRODUCT_VALIDATION: PREVIEW.18 GENERATOR 91/91, RUNTIME 273/273, FOCUSED S 44/44 PLUS TEN REPEATS, ACTUAL DEBUG NATIVE 273/273, FINAL CLEAN CONSUMERS/PACKAGE BYTES/LOCAL RELEASE GATES PASS
...
- Windows non-ASCII STEP/IGES paths use validated cleanup-safe ASCII staging in Preview.13.
