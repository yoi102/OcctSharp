...
| [ADR-0082](adr/0082-broad-batch-q-through-t-preparation.md) | Prepare Q-T as four 40-capability whole waves with exact-root audits, preserved source boundaries and explicit per-batch baseline revalidation | Accepted; Q/R 80/80 locally validated, S/T prepared |
