...
| [ADR-0082](adr/0082-broad-batch-q-through-t-preparation.md) | Prepare Q-T as four 40-capability whole waves with exact-root audits, preserved source boundaries and explicit per-batch baseline revalidation | Accepted; Q 40/40 locally validated, R-T prepared |
| [ADR-0083](adr/0083-extended-batches-and-continuous-execution.md) | Add U-W and prepare continuous Q-W execution with full per-batch validation/local commits and automatic advancement after explicit start | Active continuous run; 40/280 locally validated |
