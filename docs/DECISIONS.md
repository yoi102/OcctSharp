...
| [ADR-0077](adr/0077-iges-xde-metadata-path-interoperability-batch.md) | Define Batch N as one 24-capability metadata-aware IGES/XDE, Unicode-path, viewer, and package wave | Accepted for implementation |
