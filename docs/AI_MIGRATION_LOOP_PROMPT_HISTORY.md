# Historical Batch F migration prompt

Reference only. Use [the current prompt](AI_MIGRATION_LOOP_PROMPT.md), [STATUS](STATUS.md) and [WORKFLOW](WORKFLOW.md). Historical mandatory checklists below do not override current policy.
