...
namespace
{
constexpr uint32_t AbiVersion = 0x00010033U;
constexpr const char* BridgeVersion = "0.59.0";
...
void ValidateArray(const void* values, int32_t count, const char* message);
