...
$gates = @(
    ...
    [ordered]@{ id = 'package-consumer'; state = 'PASS'; evidence = "$PackageVersion clean restore/publish/runtime with $nativeDllCount DLLs, $emittedCount generated declarations, inherited complete Batch D/E/F/G/H/I/J workflows, and the complete Batch K assembly authoring, occurrence path, graph/BOM, reference, effective-metadata, property-rollup, history, STEP/XDE, real-HWND screenshot, and source-disposal workflow." },
