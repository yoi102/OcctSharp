...
param(
    [string]$OcctRoot,
    [string]$PackageVersion = '8.0.1-preview.4',
...
$gates = @(
    ...
    [ordered]@{ id = 'package-consumer'; state = 'PASS'; evidence = "$PackageVersion clean restore/publish/runtime with $nativeDllCount DLLs, $emittedCount generated declarations, inherited complete Batch D/E/F workflows, and the complete Batch G exact/polygonal HLR, owning category layers, section, copied polyline, layered SVG, standard-view, STEP/XDE, and real-HWND screenshot workflow." },
